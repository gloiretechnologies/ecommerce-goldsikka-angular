...
@Component({
  selector: 'app-cartpage-ecom',
  templateUrl: './cartpage-ecom.component.html',
  styleUrls: ['./cartpage-ecom.component.scss'],
  
})
export class CartpageEcomComponent implements OnInit {
  chosenName: string = '';
 count:any;
filter: any;
option: any;
