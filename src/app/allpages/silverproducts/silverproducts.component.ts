...
@Component({
  selector: 'app-silverproducts',
  templateUrl: './silverproducts.component.html',
  styleUrls: ['./silverproducts.component.scss']
})
export class SilverproductsComponent implements OnInit {
selectedIndex: any;
  select: any;
  brandresponse: any;
