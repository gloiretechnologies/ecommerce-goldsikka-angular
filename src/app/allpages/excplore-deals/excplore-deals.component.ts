...
@Component({
  selector: 'app-excplore-deals',
  templateUrl: './excplore-deals.component.html',
  styleUrls: ['./excplore-deals.component.scss']
})

export class ExcploreDealsComponent implements OnInit {
  selectedIndex: any;
  select: any;
